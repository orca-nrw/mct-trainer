...
Es gibt verschiedene Möglichkeiten den Trainer zu benutzen. Am einfachsten ist die Verwendung der [auf GitHub bereitgestellten Version](https://eild-nrw.github.io/mct-trainer). Diese wird bei Änderungen regelmäßig Aktualisiert und muss nicht selbst betrieben werden.
